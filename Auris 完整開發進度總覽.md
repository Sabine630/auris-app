...
**驗證**：新增 13 項測試（晚安偵測正反例、隔天呼應跨日／3 小時／36 小時邊界），全套 Vitest 250/250 通過；production build 通過。
...
| `services/__tests__/chatEngine.test.js` | 新增 isGoodnightText／sleepRecallState 13 項測試 |
