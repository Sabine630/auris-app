...
**最後更新**：2026-07-12
**當前版本**：P107（P105/P106 測試回饋修正——心聲刪除列定位＋分享卡主題色與一問一答＋心聲簡體字/拒絕句）
**狀態**：上線後持續優化中
...
### P107 測試回饋修正：心聲刪除列定位＋分享卡主題色與一問一答＋心聲簡體字/拒絕句（2026-07-12，當前版本）
...
| `speech.js` | 訊息朗讀：speechSynthesis＋括號動作剝除（P106） |
