...
**最後更新**：2026-06-05
**當前版本**：P67（時間感知 Bug 修正・聊天日期分隔線・卡片間距修正）
**狀態**：上線後持續優化中
...
- 🟢 **任務系統 ✓** — 每日互動遊戲化（暫緩，待確認獎勵機制）
- 🟢 **劇本／小說體驗 🎭** — AVG 選項分支與長篇協作創作模組（暫緩，待設計）

#### 使用者反饋待辦（上線後收集，排入階段 B）

- ✅ **角色與玩家作息設定** — 已完成（P62 角色側 + P63 玩家側）
- ✅ **自動總結記憶** — 已完成（P62）
- ✅ **玩家自訂大頭貼** — 已完成（P62）
- ✅ **圖片傳送與 AI 識別** — 已完成（P65，512px 壓縮，三家 API 格式支援）
